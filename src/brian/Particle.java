...
public class Particle implements Serializable{
	...
	public void force(double side, double rcoff,int mdsize,int x, double xx, double yy, double zz,double [] epot,double [] vir,int[] interacts, double[][][] sh_force2, Particle[] one, int id) {
